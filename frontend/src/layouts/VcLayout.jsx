...
function VcLayout({ user, setUser }) {
    ...
    <Box>
      <AppBar position="static" color="default" elevation={1}>
        <Toolbar>
          ...
          <Box>
            <NavLink to="/deal-flow" style={({ isActive }) => ({ ...navLinkStyle, ...(isActive ? activeLinkStyle : {}) })}>
              Deal Flow
            </NavLink>
            <NavLink to="/portfolio" style={({ isActive }) => ({ ...navLinkStyle, ...(isActive ? activeLinkStyle : {}) })}>
              My Portfolio
            </NavLink>
